...
@section('title', 'ویرایش دسته‌بندی تگ')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ویرایش دسته‌بندی تگ: {{ $tagCategory->name }}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('panel.tag-categories.update', $tagCategory) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           id="name" name="name" value="{{ old('name', $tagCategory->name) }}" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" 
                                           id="color" name="color" value="{{ old('color', $tagCategory->color) }}" required>
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3">{{ old('description', $tagCategory->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $tagCategory->sort_order) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_required" name="is_required" 
                                       value="1" {{ old('is_required', $tagCategory->is_required) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="all_categories" name="all_categories" 
                                           value="1" {{ old('all_categories', empty($tagCategory->required_for_projects)) ? 'checked' : '' }}>
                                ...
                                <div id="project_categories" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="required_for_projects[]" 
                                                       value="construction" id="construction" {{ in_array('construction', old('required_for_projects', $tagCategory->required_for_projects ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="required_for_projects[]" 
                                                       value="industrial" id="industrial" {{ in_array('industrial', old('required_for_projects', $tagCategory->required_for_projects ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="required_for_projects[]" 
                                                       value="infrastructure" id="infrastructure" {{ in_array('infrastructure', old('required_for_projects', $tagCategory->required_for_projects ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="required_for_projects[]" 
                                                       value="energy" id="energy" {{ in_array('energy', old('required_for_projects', $tagCategory->required_for_projects ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="required_for_projects[]" 
                                                       value="petrochemical" id="petrochemical" {{ in_array('petrochemical', old('required_for_projects', $tagCategory->required_for_projects ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="required_for_projects[]" 
                                                       value="other" id="other" {{ in_array('other', old('required_for_projects', $tagCategory->required_for_projects ?? [])) ? 'checked' : '' }}>
