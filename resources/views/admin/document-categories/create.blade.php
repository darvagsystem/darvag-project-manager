...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">ایجاد دسته‌بندی جدید برای سازماندهی مدارک</p>
    </div>
    <div>
...
<form method="POST" action="{{ route('panel.document-categories.store') }}" class="category-form">
    @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="color_text" value="{{ old('color', '#3b82f6') }}"
