    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('panel.payment-types.create') }}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <div class="rounded-circle mr-2" style="width: 20px; height: 20px; background-color: {{ $paymentType->color }}; border: 1px solid #ddd;"></div>
                                            <span class="text-muted small" style="font-family: monospace;">{{ $paymentType->color }}</span>
                                        </div>
                                    </td>
                                    <td class="text-center align-middle">
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('panel.payment-types.show', $paymentType) }}"
                                               class="btn btn-sm btn-outline-primary" title="مشاهده">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('panel.payment-types.edit', $paymentType) }}"
...
function toggleStatus(paymentTypeId, newStatus) {
    fetch(`/panel/payment-types/${paymentTypeId}/toggle-status`, {
        method: 'PATCH',
        headers: {
...
function confirmDelete(paymentTypeId, paymentTypeName) {
    ...
    document.getElementById('deleteForm').action = `/panel/payment-types/${paymentTypeId}`;
