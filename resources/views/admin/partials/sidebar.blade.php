<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="{{ route('project-templates.index') }}" class="nav-link {{ Request::routeIs('project-templates.*') ? 'active' : '' }}">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="nav-item">
                <a href="{{ route('backup') }}" class="nav-link {{ Request::routeIs('backup') ? 'active' : '' }}">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
