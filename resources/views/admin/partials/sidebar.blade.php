<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="{{ route('analytics') }}" class="nav-link {{ Request::routeIs('analytics') ? 'active' : '' }}">
                    ...
                    <span class="nav-text">تحلیل و گزارش</span>
                </a>
            </div>
        </div>
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="{{ route('admin.blog') }}" class="nav-link {{ Request::routeIs('admin.blog') ? 'active' : '' }}">
                    ...
                    <span class="nav-text">وبلاگ و اخبار</span>
            ...
            <div class="nav-item">
                <a href="{{ route('file-manager.index') }}" class="nav-link {{ Request::routeIs('file-manager.*') ? 'active' : '' }}">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 7 5-5 5 5"></path>
                    </svg>
        ...
        <div class="nav-section">
            <div class="nav-section-title">مدیریت کاربران</div>
            <div class="nav-item">
            ...
            <div class="nav-item">
                <a href="{{ route('admin.roles') }}" class="nav-link {{ Request::routeIs('admin.roles') ? 'active' : '' }}">
                    ...
                    <span class="nav-text">نقش‌ها و مجوزها</span>
                </a>
            </div>
        </div>
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="{{ route('admin.project-templates.index') }}" class="nav-link {{ Request::routeIs('admin.project-templates.*') ? 'active' : '' }}">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                    </svg>
                    <span class="nav-text">قالب‌های پروژه</span>
                </a>
            </div>
            <div class="nav-item">
